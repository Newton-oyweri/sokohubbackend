...
import { formatPhoneForMpesa, getTimestamp , generateToken} from './functions.js';
...
// home page
 app.get('/', (req, res) => {
    res.send('Welcome to Wonderbakes Payment Gateway API.. Available endpoint: home /  /api/stk-push, /api/stk-callback , ');
});
...
app.listen(PORT, () => {
    console.log(`Wonderbakes payment infrastructure live on port: ${PORT}`);
});